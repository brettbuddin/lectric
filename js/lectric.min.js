...
b(f)})};d.prototype.structure=function(a){var b={},f=function(){return a.find(".item").eq(0)};b.itemCount=function(){return a.find(".item").size()};b.itemHeight=function(){return parseInt(f().height(),10)};b.itemSpacing=function(){var c=f().css("marginRight");return c!==undefined?parseInt(c.replace("px",""),10):0};b.itemWidth=function(){return b.itemSpacing()+parseInt(f().width(),10)};return b};d.prototype.page=function(a){return Math.abs(Math.round(a/this.structure.itemWidth()))};d.prototype.nearestPageX=
